 ...
 *
 * Requires PROBE_TARE to also be enabled
 */
//#define Z_PROBE_ADC_STRAIN_GAGE
#ifdef Z_PROBE_ADC_STRAIN_GAGE
  #define Z_PROBE_ADC_THRESHOLD   200  // Absolute change in a 12-bit ADC which the read value changes from the tare value to indicate a trigger  
